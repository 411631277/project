                    ...
                    child: SingleChildScrollView(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: screenHeight * 0.02),
                              ...answers.keys
                                  .map((question) => _buildYesNoRow(question)),
                              SizedBox(height: screenHeight * 0.02),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                          ...
                                          onChanged: (v) {
                                            setState(() {
                                              ...
                                              if (v == true) {
                                                ...
                                                // 取消有慢性病，所有慢性病選項也清空
                                                chronicDiseaseOptions.updateAll(
                                                    (key, value) => false);
                                              }
                                            });
                                          },
                              ...
                              if (pairingResult != null)
                                Padding(
                                  ...
                                  child: Text(
                                    pairingResult!,
                                    style: TextStyle(
                                      color: pairingResult!.startsWith('配對人為')
                                          ? Colors.green
                                          : Colors.red,
                                      fontSize: 14,
                                    ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  _buildButton('下一步', Colors.blue, () async {
                                    ...
                                    if (code.isNotEmpty) {
                                      final isValid =
                                          await _validatePairingCode(code);
                                      if (!isValid) {
                                        setState(() => pairingCodeErrorMessage =
                                            '配對碼錯誤或已被使用');
                                        return;
                                      } else {
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      controller.text =
                          '$selectedWeight kg'; //更新controller.text
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      controller.text =
                          '$selectedHeight cm'; //更新controller.text
                      Navigator.pop(context); //關閉彈出視窗
                    },
                    child: const Text("確定"),
                  ),
