...
class Promisescore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final message = totalScore < 24
      ? '您對親職角色的投入可能略顯不足。承諾，不是一種壓力，而是願意每天多靠近孩子一點點的心意。親密的連結是慢慢累積的，你每一次的陪伴，都是在拉近彼此的心。給自己和孩子一點時間，你做得到。只要你在、你願意，孩子就會一直記得你的溫度。建議重新調整心態，並善用相關資源以提升親職投入'
      : '您在親職角色上展現出高度的親職承諾，願意長期且穩定地陪伴孩子成長。這樣的責任感與情感連結，是孩子安全依附發展的重要基礎，值得繼續保持這份熱忱。';
